"""Page for Ricker Wavelet 2D FDTD simulation."""
# %% Imports
...
def run_ricker_simulation(n_clicks):
...
def create_ricker_animations(set_progress, n_clicks, sim_n_clicks):
